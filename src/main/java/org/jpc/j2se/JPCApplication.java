...
public class JPCApplication
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println("Copyright (C) 2014 A.G.");
        ...
        if(autoexec != null && !noautoexec) {
            try {
                InputStreamReader input = new InputStreamReader(new FileInputStream(autoexec), "UTF-8");
                BufferedReader kbd2 = new BufferedReader(input);
                while(true) {
                ...
                if(cmd != null)
                    ...
                    synchronized(kbd) {
                        try {
                            ...
                            System.err.println("keyboard init error");
                        }
                    }
            } catch (Exception e) {
